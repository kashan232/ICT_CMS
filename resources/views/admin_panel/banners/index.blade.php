...
<div class="wrapper">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="card-header text-white d-flex justify-content-end">
                                        <a href="{{ route('banners.create') }}" class="btn" style="background-color:green !important;color:white !important">
                                            Add Banner
                                        </a>
                                    </div>
                                </div>
    ...
    @endif
                                                    ...
                                                    <td>
                                                        <a href="{{ route('banners.edit',$item->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                                        <a href="{{ route('banners.delete',$item->id) }}" onclick="return confirm('Are you sure?')" class="btn btn-sm btn-danger">Delete</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
