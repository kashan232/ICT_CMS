                        ...
                        <div class="card shadow-sm border-0 rounded-3 mt-4">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('crop.disease.subtypes.store') }}" method="POST" enctype="multipart/form-data" onsubmit="disableButton(this)">
                                    ...
                                    <button type="button" class="btn btn-secondary" id="addMoreSubDisease" style="background-color:green !important;color:white   !important">+ Add More Sub Disease</button>
