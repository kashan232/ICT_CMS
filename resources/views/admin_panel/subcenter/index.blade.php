        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="card-body mt-5">
                    <div class="row mb-3">
                        <div class="col-lg-6"><h5 class="mb-0">Subcenter Upload</h5></div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table text-center" id="userTable">
                                    ...
                                    <tbody>
                                        @foreach($subcenters as $index => $item)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                                <td>{{ $item->title }}</td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('subcenter.delete', $item->id) }}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
